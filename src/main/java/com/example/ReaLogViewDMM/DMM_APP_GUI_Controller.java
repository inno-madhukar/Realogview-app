...
public class DMM_APP_GUI_Controller {
    ...
    private Data_Holder infoHolder;
    ...
    public Data_Holder infoHolder1;
    public Data_Holder comnameDataHolder;
    public Data_Holder resultsetDataHolder;
    public Data_Holder oneYearResultHolder;
    public Data_Holder twoYearResultHolder;

    public Data_Holder todayresultHolder;
...
// Truck Numbers
    ...
    public void initialize() throws IOException, SQLException, ClassNotFoundException, SQLException {
        ...
        comnameDataHolder = new Data_Holder();
        resultsetDataHolder = new Data_Holder();
        oneYearResultHolder = new Data_Holder();
        twoYearResultHolder = new Data_Holder();
        todayresultHolder = new Data_Holder();
...
//                     AvailableRecData.setText(" Available Records  : from "+localDateTime+"to " +localDateTime1 );
    ...
    private void printPDF() throws IOException, SQLException, PrinterException {
        ...
        FXMLLoader fxmlLoader1 = new FXMLLoader(Main_Application.class.getResource("Print_Layout.fxml"));
                ...
                if (from_Date == true && to_Date == true) {
                    ...
                    if (duration60 > dration || startDate.isAfter(endDate)) {
                        ...
                        if (matchyear == matchyear1) {
                            ...
                            comnameDataHolder.setComNmae(allusedata);

                            secondController.setcompanyname(comnameDataHolder);
...
//        alert.getDialogPane().setMinSize(300,500);
    ...
    void sharepdf_after_validate(String address) throws SQLException, IOException, MessagingException {
        ...
        if (matchyear == matchyear1) {
            ...
            byte[] pdfbytes = printAndPdfOfTableRecords.getpdfbytes(result1, comName, comaddress, comemail, comphon);
            ...
            Print_And_Pdf_Of_Table_Records printAndPdfOfTableRecords1 = new Print_And_Pdf_Of_Table_Records();
            byte[] pdfbytes = printAndPdfOfTableRecords1.getpdfbytes(combinedResultSet, comName, comaddress, comemail, comphon);
            sendEmailWithAttachment(smtpHost, senderEmail, senderPassword, address.trim(), subject, body, pdfbytes);
...
//        }
        Print_And_Pdf_Of_Table_Records printAndPdfOfTableRecords = new Print_And_Pdf_Of_Table_Records();
        byte[] pdfbytess = printAndPdfOfTableRecords.getpdfbytes(resultSet, comName, comaddress, comemail, comphon);
