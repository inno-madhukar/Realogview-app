...
public class DMContiguity {
    ...
    public Label tfl1;  public Label tfl2;  public Label tfl3;  public Label tfl4;  public Label tfl5;
    public Label tfl6;  public Label tfl7;  public Label tfl8;  public Label tfl9;  public Label tfl10;
...
//            openporttittle.setText("Open Port : ");
    ...
    public void portgetdata(ActionEvent event) throws InterruptedException, IOException {
        ...
        conectionwindow.setVisible(false);
        Tfd6.setVisible(false); tfl6.setVisible(false);
        Tfd7.setVisible(false); tfl7.setVisible(false);
        Tfd8.setVisible(false); tfl8.setVisible(false);
        Tfd9.setVisible(false); tfl9.setVisible(false);
        Tfd10.setVisible(false); tfl10.setVisible(false);
        Tfd1.setText(""); Tfd6.setText("");
        Tfd2.setText("");Tfd7.setText("");
        Tfd3.setText("");Tfd8.setText("");
        Tfd4.setText("");Tfd9.setText("");
        Tfd5.setText("");Tfd10.setText("");
...
//                Blemodulename=ab[1];
    ...
    void portdisCoAle(){
        _serialPort.addDataListener(new  SerialPortDataListener() {
                @Override
                public int getListeningEvents() { return _serialPort.LISTENING_EVENT_PORT_DISCONNECTED; }
                @Override
